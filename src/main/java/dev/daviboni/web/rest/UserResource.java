...
import dev.daviboni.config.Constants;
import dev.daviboni.domain.User;
import dev.daviboni.repository.UserRepository;
import dev.daviboni.security.AuthoritiesConstants;
import dev.daviboni.service.MailService;
import dev.daviboni.service.UserService;
import dev.daviboni.service.dto.AdminUserDTO;
import dev.daviboni.web.rest.errors.BadRequestAlertException;
import dev.daviboni.web.rest.errors.EmailAlreadyUsedException;
import dev.daviboni.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link dev.daviboni.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
