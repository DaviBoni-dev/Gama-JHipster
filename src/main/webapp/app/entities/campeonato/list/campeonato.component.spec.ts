...
import { sampleWithRequiredData } from '../campeonato.test-samples';
...
describe('Campeonato Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.campeonatoes()[0]).toEqual(expect.objectContaining({ id: 4328 }));
  });

  describe('trackId', () => {
    it('Should forward to campeonatoService', () => {
      const entity = { id: 4328 };
      jest.spyOn(service, 'getCampeonatoIdentifier');
      const id = comp.trackId(entity);
      expect(service.getCampeonatoIdentifier).toHaveBeenCalledWith(entity);
