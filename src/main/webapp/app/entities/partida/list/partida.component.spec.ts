...
import { sampleWithRequiredData } from '../partida.test-samples';
...
describe('Partida Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.partidas()[0]).toEqual(expect.objectContaining({ id: 21967 }));
  });

  describe('trackId', () => {
    it('Should forward to partidaService', () => {
      const entity = { id: 21967 };
      jest.spyOn(service, 'getPartidaIdentifier');
      const id = comp.trackId(entity);
      expect(service.getPartidaIdentifier).toHaveBeenCalledWith(entity);
